...
ALTER TABLE USER_BELONG ADD COLUMN IS_ENDPOINT_NULL INTEGER AS (CASE WHEN ENDPOINT IS NULL THEN 1 END);

DROP INDEX UK_USER_BELONG;
CREATE UNIQUE INDEX IF NOT EXISTS UK_USER_BELONG
    ON USER_BELONG (OBJECT_ID, OBJECT_TYPE, USER_ID, USER_TYPE_CODE, IS_ENDPOINT_NULL);